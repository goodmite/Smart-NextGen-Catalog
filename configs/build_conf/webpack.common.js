    ...
    alias: Object.assign(
      {
        ...
        '@sharedInterface': path.resolve(__dirname, '../../src', 'interfaces'),
        '@sharedEnums': path.resolve(__dirname, '../../src', 'enums'),
  ...
  config.plugins = [
    new CopyWebpackPlugin(
      [
        ...
        {
          from: 'distribution/__buildVersion___Document/locale_files',
    ...
    new CsvToJson({
      ...
      outputPath: 'distribution/__buildVersion___Document/locale_files'
    }),
    new CopyWebpackPlugin([
      { from: 'distribution/__buildVersion___Document/locale_files', to: 'distribution/__buildVersion___Document/locale_files' }
    ], { debug: 'debug' }),
  ];
